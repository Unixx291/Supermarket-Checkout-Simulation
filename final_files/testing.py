...
class MyGUI:
    def __init__(self):
        ...
        self.label_customer_count = tk.Label(self.window, text=f'Number of Customers: {self.customer_count}', font=('Arial', 16))
        ...
        self.btn_generate = tk.Button(self.window, text='Start Simulation', font=('Arial', 16), command=self.start_simulation)
