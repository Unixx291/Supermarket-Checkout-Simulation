...
def simulation(stop_event):
    ...
    for _ in range(8):
        ...
        # / Loops 8 times with a random number of new customers between 1 and 10 so customers waiting
        # to join any lane cannot exceed 40 (80 maximum customers within the lanes and waiting to join any lane) /
        ...
        threads += [threading.Thread(target=customer.simulate_checkout_and_remove_customer) for customer in
